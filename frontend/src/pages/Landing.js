      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
          ...
          <Sheet>
            ...
            <SheetContent className="w-[85vw] sm:w-[400px]">
              ...
              <div className="mt-6 space-y-4 sm:space-y-6 overflow-y-auto max-h-[calc(100vh-120px)]">
                <div>
                  <label className="font-body font-medium mb-2 block text-sm">Gender</label>
                ...
                <div>
                  <label className="font-body font-medium mb-2 block text-sm">Marital Status</label>
                ...
                <div>
                  <label className="font-body font-medium mb-2 block text-sm">Education</label>
                  <Input
                ...
                <div>
                  <label className="font-body font-medium mb-2 block text-sm">City</label>
                  <Input
                ...
                <div>
                  <label className="font-body font-medium mb-2 block text-sm">State</label>
                  <Input
                ...
                <div>
                  <label className="font-body font-medium mb-2 block text-sm">Income Range</label>
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="font-heading text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3" style={{ color: 'var(--text-primary)' }}>
            ...
            <span className="text-xl sm:text-3xl">Find Your Perfect Match</span>
          </h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 sm:py-20">
            <p className="font-body text-base sm:text-lg" style={{ color: 'var(--text-secondary)' }}>No profiles found. Try adjusting your filters.</p>
          </div>
        ) : (
                ...
                <div className="relative aspect-[3/4] sm:aspect-[4/5]">
                  ...
                  {profile.is_premium && user && (
                    ...
                    >
                      ...
                      <span className="text-xs font-body font-medium hidden sm:inline">Premium</span>
                    </div>
                  )}
